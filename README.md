...
- **A peça sempre aparece inteira na foto:** o encaixe da imagem na moldura oval é feito sem cortar nenhuma parte da peça, mesmo quando a foto original tem um formato bem diferente do oval (ex.: fotos bem verticais ou horizontais) — o espaço que sobra fica com o mesmo fundo creme do oval, sem cortar anel, brinco, colar etc.
